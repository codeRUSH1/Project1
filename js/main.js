...
const gunStartingPosition = document.getElementById()
...
- Mounted gun should be able to shoot projectiless, and move from left to right alongside the grid. it is not able to move vertically though.
